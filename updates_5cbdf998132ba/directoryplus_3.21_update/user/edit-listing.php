...
if(!empty($place_id)) {
	...
	$query = "SELECT s1.*, s2.field_value FROM
				...
				SELECT cf.*
					...
					LEFT JOIN rel_cat_custom_fields
						ON cf.field_id = rel_cat_custom_fields.field_id
...
// v.3.08
$txt_upload_limit = !isset($txt_upload_limit) ? 'Upload limit reached' : $txt_upload_limit;