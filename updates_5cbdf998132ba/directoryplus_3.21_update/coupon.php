...
$query = "SELECT  p.slug AS place_slug, p.place_name, p.place_id,
			c.slug AS city_slug,
...
$city_slug  = !empty($row['slug'      ]) ? $row['slug'      ] : 'location';
...
$place_slug = !empty($row['place_slug']) ? $row['place_slug'] : $place_id;
$place_name = !empty($row['place_name']) ? $row['place_name'] : $place_id;

$place_link = $baseurl . '/listing/' . $state_slug . '/' . $city_slug . '/' . $cat_slug . '/' . $place_slug;

/*--------------------------------------------------
canonical
--------------------------------------------------*/
$canonical = $baseurl . '/coupon';
