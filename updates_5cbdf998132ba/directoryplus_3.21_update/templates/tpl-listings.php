			...
			foreach($custom_fields as $k => $v) {
				...
				<div class="mb-3" id="li-field-<?= $v['field_id'] ?>">
					...
					elseif($v['filter_display'] == 'range_text') {
						?>
						<div class="form-group">
							<input type="text" id="val_<?= $v['field_id'] ?>_from" class="form-control" name="field_<?= $v['field_id'] ?>[]">
							<input type="text" id="val_<?= $v['field_id'] ?>_to" class="form-control" name="field_<?= $v['field_id'] ?>[]">
						</div>
						<?php
					}
					...
					elseif($v['filter_display'] == 'range_number') {
						?>
						<div class="form-group">
							<input type="number" id="val_<?= $v['field_id'] ?>_from" class="form-control mb-1" name="field_<?= $v['field_id'] ?>[from]">
							<input type="number" id="val_<?= $v['field_id'] ?>_to" class="form-control" name="field_<?= $v['field_id'] ?>[to]">
						</div>
						<?php
					}
			...
			<div class="container-fluid item-list">
				...
				if($total_rows > 0) {
					foreach($list_items as $k => $v) {
						$place_link = "$baseurl/listing/" . $v['state_slug'] . "/" . $v['city_slug'] . "/" . $v['cat_slug'] . "/" . $v['place_slug'];
