		...
		<ul class="navbar-nav ml-auto">
			...
			if(!empty($_SESSION['user_connected'])) {
				...
				<li class="nav-item mr-md-3">
					<a href="<?= $baseurl ?>/user/select-plan" id="navbarBtnCreateListing" class="btn btn-block text-white"><i class="far fa-plus-square"></i> <?= $txt_create_listing ?></a>
				</li>

				<li class="nav-item dropdown mr-md-3">
					<a href="#" id="navbarExploreDropdown" class="btn btn-block text-white" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-ellipsis-v"></i> <?= $txt_explore ?>
					</a>
			...
			// user is not logged in
				...
				?>
				<li class="nav-item mr-md-3">
					<a href="<?= $baseurl ?>/user/sign-in" id="navbarBtnSignIn" class="btn btn-block text-white"><i class="fas fa-sign-in-alt"></i> <?= $txt_signin ?></a>
				</li>
							...
							<div class="d-flex flex-column" style="height:100%;">
								...
								<div class="mt-auto text-right">
									<div class="btn pointer">
										<span class="add-to-favorites" data-place-id=<?= $v['place_id'] ?>><i class="<?= in_array($v['place_id'], $favorites) ? 'fas' : 'far' ?> fa-heart"></i></span>
									</div>
								</div>
							</div>
						</div>
