		...
		<div class="col-md-8 col-lg-9">
			...
			<form method="post" id="create-listing-form" action="<?= $baseurl ?>/user/process-create-listing">
				...
				<div class="form-row mb-5">
					...
					<div class="col-2">
						<input type="text" id="area_code" class="form-control" name="wa_area_code" placeholder="<?= $txt_area_code ?>">
					</div>

					<div class="col-7">
						<input type="tel" id="phone" class="form-control" name="wa_phone" placeholder="<?= $txt_phone ?>">
					</div>
				</div>
				...
				<div class="form-group block">
					...
					<div class="mb-3">
						<a id="upload-button" class="btn btn-light pointer">
							<i class="fas fa-plus"></i> <?= $txt_upload_btn ?>
						</a>
					</div>
				</div>
