...
<div class="container mt-5">
	<div class="row">
		...
		<div class="col-md-8 col-lg-9">
			...
			<form method="post" id="the_form" action="<?= $baseurl ?>/user/process-edit-listing">
				...
				<div class="form-row mb-5">
					...
					<div class="col-2">
						<input type="text" id="area_code" class="form-control" name="wa_area_code" value="<?= $wa_area_code ?>">
					</div>

					<div class="col-7">
						<input type="tel" id="phone" class="form-control" name="wa_phone" value="<?= $wa_phone ?>">
					</div>
				</div>
				...
				<div class="form-group">
					<label for="category_id"><?= $txt_category ?></label>
				...
				<div class="form-group">
					<input type="text" id="category_id_hidden" class="form-control" name="category_id_hidden" style="height:0;padding:0;opacity:0" value="<?= $cat_id ?>" required>
				</div>
