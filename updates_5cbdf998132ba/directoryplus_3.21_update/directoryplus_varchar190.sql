...
CREATE TABLE IF NOT EXISTS `places` (
  ...
  `short_desc` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
('en', 'user', 'register', 'txt_submit_again', 'Please <a href=''http://localhost/directoryplus/user/register''>submit the form</a> again.'),
('en', 'user', 'register', 'baseurl', 'http://localhost/directoryplus'),
