<?php
if(file_exists(__DIR__ . '/head-child.php')) {
...
if(cookieEnabled() === true && lsTest() === true) {
	if ('geolocation' in navigator) {
		navigator.geolocation.getCurrentPosition(function(position) {
			...
			// cookie geo_city_id
			var cookie_geo_city_id = <?= isset($_COOKIE['geo_city_id']) ? $_COOKIE['geo_city_id'] : 0 ?>;
...
<!-- Maps -->
<?php
if(in_array($route[0], array('listings', 'listing', 'search', 'advanced-results', 'results'))
	||
