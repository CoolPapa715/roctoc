...
$place_user_firstname = $row['first_name'];
...
if(!empty($email_body)) {
	...
	$email_subject = str_replace('%listing_link%', $link_url, $email_subject);
	$email_subject = str_replace('%place_link%', $link_url, $email_subject);
	...
	$email_body    = str_replace('%listing_link%', $link_url, $email_body);
