...
function exception_handler($e) {
	...
	echo "<br><strong>Exception File:</strong> " . $e->getFile();
...
function cat_name_transl($cat_id, $user_lang, $form = 'singular', $orig_str) {
	...
	else if ($form == 'plural' && !empty($cat_lang[$user_lang][1])) {
...
--------------------------------------------------*/
function get_listing_link($place_id) {
	global $conn;
	global $baseurl;
	...
	$link_url = "$baseurl/$route_listing/$state_slug/$city_slug/$cat_slug/$place_slug";
