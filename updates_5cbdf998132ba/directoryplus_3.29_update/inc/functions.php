...
function exception_handler($e) {
	...
	echo "<br><strong>Exception Line:</strong> " . $e->getLine();
	echo "<br><strong>Exception File:</strong> " . basename($e->getFile());
	echo "<br>";
}
...
function error_handler($errno, $errstr, $errfile, $errline) {
	...
	echo "<strong>Error Number:</strong> $errno";
	echo "<br><strong>Error String:</strong> $errstr";
	echo "<br><strong>Error Line:</strong> $errline";
	echo "<br><strong>Error File:</strong> " . basename($errfile);
	echo "<br>";
}
