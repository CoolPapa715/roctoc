...
<nav id="header-nav" class="navbar navbar-expand-md fixed-top">
	...
	<a class="navbar-brand" href="<?= $baseurl ?>">
		<img class="logo" alt="<?= $site_name ?>" src="<?= $baseurl ?>/assets/imgs/logo-white.png" width="<?= $site_logo_width ?>">
	</a>
	...
	<div id="navbarSupportedContent" class="collapse navbar-collapse text-white mr-md-5">
		...
		<!--		<li class="nav-item mr-md-3">
				...
				<li class="nav-item dropdown">
					<a href="#" id="navbarUserDropdown" class="btn btn-block btn-outline-light" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="far fa-user"></i> <?= $txt_user ?>
					</a>

					<div class="dropdown-menu dropdown-menu-right zoomIn" aria-labelledby="navbarUserDropdown">
		...
		<!--		<li class="nav-item">
					<a href="<?= $baseurl ?>/user/register" id="navbarBtnGetListed" class="btn btn-block btn-outline-light"><?= $txt_get_listed ?> <i class="fas fa-chevron-right"></i></a>
				</li> -->
				<?php
			}
			?>
...
<!-- Jumbotron -->
<div class="jumbotron d-flex text-center" style="background-image: url('<?= $cfg_hero_img ?>?nocache');">
	<div class="container my-auto text-center">
		<div class="typewriter h1"><h1 class="mb-2 text-white"><?= $txt_phrase_01 ?></h1></div>
...
<br/><br/>
	...
	<br/>
		Best Business Categories: <a href="https://roctoc.com/listings/Affiliate-Networks"><i class="fas fa-link"></i><b>Affiliate Networks,</b></a><a href="https://roctoc.com/listings/Web-Hosting"><b> <i class="fas fa-link"></i> Web Hosting,</b></a><a href="https://roctoc.com/listings/influencers"><b> <i class="fas fa-link"></i> Influencers,</b></a><a href="https://roctoc.com/categories"> More...</a>
	</div>
</div>
				...
				<div class="col-sm-6 col-lg-3 text-center mb-4">
					...
					if(!isset($cfg_cat_display) || $cfg_cat_display == 'image') {
						...
						<div class="card text-white">
							<a href="<?= $baseurl ?>/listings/<?= $v['cat_slug'] ?>" title="<?= $v['cat_name'] ?>" class="text-white">
								<img class="card-img" src="<?= $v['cat_img'] ?>" alt="<?= $v['cat_name'] ?>">
								<div class="card-img-overlay">
									<h5 class="card-title text-white"><?= $v['cat_name'] ?></h5>
								</div>
							</a>
						</div>
						<?php
							...
							<div class="d-flex flex-column" style="height:100%;">
								...
								<div class="mt-auto text-right">
									<div class="btn pointer">
										<span class="add-to-favorites" data-listing-id=<?= $v['place_id'] ?>><i class="<?= in_array($v['place_id'], $favorites) ? 'fas' : 'far' ?> fa-heart fa-spin"></i></span>
									</div>
								</div>
							</div>
						</div>
