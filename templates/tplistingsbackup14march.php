...
<div id="public-listings" class="container-fluid">
	...
	<!-- Sidebar -->
	 <img src="https://roctoc.com/assets/imgs/your.gif" alt="Banner space ad">
		...
		foreach($coupons_arr as $k => $v) {
			...
			<div class="row mb-3" id="coupon-<?= $v['coupon_id'] ?>">
				<div class="col-md-3 mb-3 coupon-img" id="<?= $v['coupon_id'] ?>">
					<a href="<?= $baseurl ?>/coupon/<?= $v['coupon_id'] ?>"><img src="https://thumbs.dreamstime.com/b/ad-icon-vector-ads-collection-thin-line-outline-illustration-linear-symbol-use-web-mobile-apps-logo-print-media-142852297.jpg"></a>
				</div>

				<div class="col-md-9 mb-3 coupon-body">
					<div class="item-title-row mb-3">
						<h5><a href="<?= $baseurl ?>/coupon/<?= $v['coupon_id'] ?>"><?= e($v['coupon_title']) ?></a></h5>
					</div>

					<div class="mb-3"><?= e($v['coupon_description']) ?></div>

					<div class="mb-3">
						<a href="<?= $baseurl ?>/coupon/<?= $v['coupon_id'] ?>" class="btn btn-dark"><strong>View Details</strong></a>
					</div>
					...
					<div>
						...
						<i class="fab fa-twitter" aria-hidden="true"></i> Tweet</a>

						<!-- facebook share 
						<a href="#"
						class="badge badge-pill badge-light"
						onclick="window.open('<?= $v['facebook_link'] ?>','facebook-share-dialog', 'width=626,height=436'); return false;">
						<i class="fab fa-facebook" aria-hidden="true"></i> Share</a>

						<!-- mail 
						<a href="<?= $v['mailto_link'] ?>"
						class="badge badge-pill badge-light">
						<i class="fas fa-envelope" aria-hidden="true"></i> Mail</a>

						<!-- print
						<a href="<?= $v['coupon_img'] ?>" target="_blank"
						class="badge badge-pill badge-light">
						<i class="fas fa-print" aria-hidden="true"></i> Print</a>
					</div>
				</div>
			</div>
